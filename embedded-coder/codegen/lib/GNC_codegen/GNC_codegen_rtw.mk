...
svd.obj : "$(START_DIR)\codegen\lib\GNC_codegen\svd.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\GNC_codegen\svd.c"


xzlangeM.obj : "$(START_DIR)\codegen\lib\GNC_codegen\xzlangeM.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\GNC_codegen\xzlangeM.c"
...
pad_filter.obj : "$(START_DIR)\codegen\lib\GNC_codegen\pad_filter.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\GNC_codegen\pad_filter.c"
...
xrotg.obj : "$(START_DIR)\codegen\lib\GNC_codegen\xrotg.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\GNC_codegen\xrotg.c"


xzlascl.obj : "$(START_DIR)\codegen\lib\GNC_codegen\xzlascl.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\GNC_codegen\xzlascl.c"
