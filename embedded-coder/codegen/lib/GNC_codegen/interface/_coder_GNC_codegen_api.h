...
void controller_codegen_entry(real_T b_time, real_T dt_ctrl,
                              real_T where_it_is[2], real_T pdyn,
                              real_T delta_encoder, struct0_T *ctrl_mem,
                              real_T *u_motor, real_T where_it_isnt[2],
