                     ...
                     double *airdata_mach, double *airdata_dynamic_pressure)
{
  ...
  double layer_idx_3;
  int layer_idx_0;
  /*  computes atmospheric stanadard data from altitude, according to US
   * standard atmosphere  */
  /*  atmosphere data: static pressure, temperature, density, local speed of
   * sound */
...
/* End of code generation (airdata_atmos.c) */
