function [sdt, sdt_vars] = sim_postprocessor(simout)
    ...
    rocket = synchronize(sdt_vars.q, sdt_vars.w, sdt_vars.v, sdt_vars.alt, sdt_vars.pos_yz);
        rocket = renamevars(rocket, 1:7, ["q", "w", "v", "alt", "pos_yz"]);
    ...
    sdt.est = synchronize(sdt_vars.qhat, sdt_vars.what, sdt_vars.vhat, sdt_vars.althat);
        sdt.est = renamevars(sdt.est, 1:6, ["q", "w", "v", "alt"]);
    ...
    sdt.error = synchronize(sdt_vars.qerr, sdt_vars.werr, sdt_vars.verr, sdt_vars.alterr);
        sdt.error = renamevars(sdt.error, 1:6, ["q", "w", "v", "alt"]);
